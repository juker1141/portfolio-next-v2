...
const Work = ({ isWideScreen }: { isWideScreen: boolean }) => {
  ...
  return (
    <Fragment>
      <section
        id="work"
        className="container h-screen mx-auto flex flex-col justify-center items-center relative px-8 lg:px-0"
      >
        <Image
        ...
        >
          I frequently dedicate my spare time to researching new technologies or
