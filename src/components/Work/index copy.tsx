        ...
        <div className="slide" id="workId1" data-anchor="workBanner">
          <div className="container h-screen mx-auto flex flex-col justify-center items-center relative px-8 lg:px-0">
            ...
            {/* <Image
              width={isWideScreen ? 200 : 150}
              height={isWideScreen ? 200 : 150}
              className={`absolute bottom-24 left-6 lg:left-12 transition-transform duration-1000 transform3d-x-none ${
                isScrollUp && "transform3d-x-lg"
              }`}
              src="images/sp-main.svg"
              alt="sp-main"
            />
            ...
            <Image
              width={30}
              height={30}
              className={`absolute top-32 lg:top-52 xl:top-24 left-10 lg:left-36 xl:right-52 transition-transform duration-300 transform3d-x-none ${
                isScrollUp && "transform3d-x-lg"
              }`}
              src="images/element/e-14.svg"
              alt="e-14"
            ...
            <Image
              width={15}
              height={15}
              className={`absolute top-40 lg:top-64 xl:top-32 left-16 lg:left-48 xl:right-48 transition-transform duration-1200 transform3d-x-none ${
                isScrollUp && "transform3d-x-lg"
              }`}
              src="images/element/e-13.svg"
              alt="e-13"
