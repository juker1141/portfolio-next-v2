    ...
    >
      <div className="w-full lg:w-auto flex justify-between">
        <h1 className="text-2xl flex items-center">
          <Link href="#banner">
            <Image src="/images/logo3.svg" alt="logo" width="60" height="60" />
          </Link>
        </h1>
      ...
      >
        <ul className="flex flex-col lg:flex-row items-start lg:items-center py-8 lg:py-0 font-amatic-sc font-bold text-5xl">
          {NavData.map((nav) => {
            return (
